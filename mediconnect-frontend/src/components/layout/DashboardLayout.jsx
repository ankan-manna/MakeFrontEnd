...
export function DashboardLayout() {
  ...
  const sidebarContent = (
    <>
      {/* Logo */}
      <div className="px-5 py-5 border-b border-neutral-100/80">
      ...
      <div className="px-4 pt-4 pb-2">
        <div className="px-3 py-2.5 rounded-xl bg-badge-glow border border-neutral-100">
          <div className="flex items-center gap-2">
            <Sparkles className="w-3.5 h-3.5 text-primary-500" />
            <p className="text-xs font-medium text-neutral-400 uppercase tracking-wider">Logged in as</p>
          </div>
          <p className="text-sm font-semibold text-neutral-700 mt-1">{ROLE_LABELS[role]}</p>
        </div>
      </div>
      ...
      {/* Logout */}
      <div className="px-3 py-4 border-t border-neutral-100/80">
        <button
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex">
      {/* Sidebar - desktop */}
      <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-neutral-200/60 fixed inset-y-0 left-0 z-30">
        {sidebarContent}
      </aside>
      ...
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-64 bg-white border-r border-neutral-200/60 flex flex-col transform transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] lg:hidden ${
      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-h-screen">
        {/* Top bar */}
        <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-xl border-b border-neutral-200/60 h-16 flex items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            {/* Search (visual only) */}
            <div className="hidden sm:flex items-center gap-2 px-3.5 py-2.5 rounded-xl bg-neutral-50 border border-neutral-200/60 text-neutral-400 text-sm min-w-[240px] hover:border-neutral-300 transition-soft">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              >
                <div className="w-8 h-8 rounded-xl bg-primary-100 flex items-center justify-center ring-2 ring-primary-200/50">
              ...
              {profileOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-52 py-1.5 bg-white rounded-xl shadow-elevated border border-neutral-200/60 z-20 animate-scale-in">
                    <Link
